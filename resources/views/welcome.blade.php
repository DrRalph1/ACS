...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>ACS - Adaptive Computer Solutions</title>
    ...
    <p style="font-size: 20px; text-align: left !important;">
        ...
        <b>## Guidelines to enable the young lady send her desired net salary and allowances via the REST API</b>

        <br><br>1. Open Postman (or any other substitute application of your choice)

        <br><br>2. Switch the method to <b>POST</b>

        <br><br>3. Enter <b>http://127.0.0.1:8000/api/sendNetSalaryANDAllowances</b> in the URL section

        <br><br>4. Navigate to the body and supply these information 
        net_salary: 2120.4 (you can enter any amount of your choice)
        allowances: 284.52 (you can enter any amount of your choice)

        <br><br>5. Click on send to submit the young lady's data.
